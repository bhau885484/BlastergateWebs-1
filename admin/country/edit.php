  ...
  <div class="span9" id="content">
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <ul class="breadcrumb">
            ...
            <i class="fa fa-angle-right show-sidebar" style="display:none;"><a href="#" title="Show Sidebar" rel="tooltip">&nbsp;</a></i><li><a href="<?php echo $base_url ?>/dashboard.php">Dashboard</a> <span class="divider">/</span></li><li><a href="#">Country</a> <span class="divider">/</span></li><li class="active">Edit Country</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="block">
      <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">Edit Country</div>
      </div>
    ...
    <div class="span12">
      <?php
            ...
            ?>    
        <form action="update.php" method="post" id="add_country_form" name="add_country_form" class="form-horizontal" accept-charset="utf-8">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="country_name" class="input-xlarge focused" placeholder="Country Name" id="country_name" readonly="1" value="<?php echo $rown['country_name']?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">Country Code</label>
                    <div class="controls">
                        <input type="text" name="country_code"  class="input-xlarge focused" placeholder="Country Code" id="country_code" readonly="1" value="<?php echo $rown['country_code']?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">Country Dialcode</label>
                    <div class="controls">
                        <input type="text" name="country_mobile_code"  class="input-xlarge focused" placeholder="Dialcode" id="country_mobile_code" value="<?php echo $rown['country_mobile_code']?>">
                    </div>
                    <div class="error" id="country_mobile_code_error"></div>
                </div>
                <div class="form-actions">
                  <input type="hidden" id="pid" name="pid" value='<?php echo $pid; ?>' >
                    <input type="submit" name="add_country" value="Update Country" class="btn btn-primary" id="submit_button">
