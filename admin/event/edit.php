                ...
                ?>  
                  <form  id="edit_form" name="edit_form" class="form-horizontal" method="post" action="update.php" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-md-2">
                         <div class="form-group mb-3">
                            <label id="basic-addon1"> Event From Time <span class="error_msg">*</span></label>
                            <input type="time" class="form-control" placeholder="Enter event time"  aria-label="name" aria-describedby="basic-addon1" name="event_from_time" id="event_from_time" value="<?php echo $rown['event_from_time']?>">
                      ...
                      <div class="col-md-2">
                         <div class="form-group mb-3">
                            <label id="basic-addon1"> Event To Time <span class="error_msg">*</span></label>
                            <input type="time" class="form-control" placeholder="Enter event time"  aria-label="name" aria-describedby="basic-addon1" name="event_to_time" id="event_to_time" value="<?php echo $rown['event_to_time']?>">
                     ...
                     <div class="col-md-4">
                       <div class="form-group mb-3">
                          <label id="basic-addon1">Event Number Of Ticket</label>
                     ...
                     <div class="col-md-4">
                       <div class="form-group mb-3">
                          ...
                          <input type="number" class="form-control"  aria-label="name" aria-describedby="basic-addon1" name="additional_room_night_price" id="additional_room_night_price" placeholder="Additional Room Night Price" value="<?php echo $rown['additional_room_night_price']?>">
                       </div>
                     </div>
                     ...
                     <div class="col-md-4">
                       <div class="form-group mb-3">
                          ...
                          <input type="number" class="form-control"  aria-label="name" aria-describedby="basic-addon1" name="additional_room_night_fee" id="additional_room_night_fee" placeholder="Additional Room Night Fee" value="<?php echo $rown['additional_room_night_fee']?>">
                       </div>
                     </div>
                     ...
                     <div class="col-md-8">
                         <div class="form-group mb-3" id="user_details">
                          <label class="control-label" for="focusedInput">Select Additional Room Night Days
                            ...
                            <?php 
                                  $weekendArr = explode(",",$rown['additional_room_night_days']);
                              ?>
                            ...
                            <div class="controls">
                                <select  name = "user[]" multiple  id="rider_list_dropdown" class="form-control" id="user_id" required="required" >
                                  <?php 
                                   ...
                                   ?>
                                  <option value="<?php echo $user['full_days'] ?>" <?php echo (isset($weekendArr) && in_array($user['full_days'], $weekendArr) ) ? "selected" : "" ?>><?php echo $user['full_days'] ?></option>
                                <?php } ?>
                                </select>
   ...
   function initMap()
    {
     ...
     function submitDetailsForm() {
      ...
      // if((event_from_time == '') || (event_from_time == undefined)){
      //   $("#event_from_time_error").text("This field are required");
      //   error = 0;
      // }else{
      //   $("#event_from_time_error").text("");
      // }
