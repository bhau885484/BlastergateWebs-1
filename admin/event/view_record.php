...
<div class="main-content side-content pt-0">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h2 class="main-content-title fs-24 mb-1">All Event User List</h2>
                        ...
                        <div class="table-responsive">
                            <div id="datatable-basic_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                               <?php
                                ...
                                $sql = "select * from  tbl_event_ticket_booking  WHERE event_id='$event_id'";
                                          ...
                                          <tbody>
                                            ...
                                            { ?>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><a href="view_single_record.php?id=<?php echo $user['id']; ?>&back_id=<?php echo $event_id ?>"><?php echo $rown_user['username']; ?></a></td>
