...
$event_from_time=mysqli_real_escape_string($connect,$_REQUEST['event_from_time']); 
$event_to_time=mysqli_real_escape_string($connect,$_REQUEST['event_to_time']); 
...
$additional_room_night_price=mysqli_real_escape_string($connect,$_REQUEST['additional_room_night_price']); 
$additional_room_night_fee=mysqli_real_escape_string($connect,$_REQUEST['additional_room_night_fee']); 

$useraarray=$_REQUEST['user']; 


$additional_room_night_days = implode(',',$useraarray);
...
if (($_FILES["event_image"]["type"] == "image/png") || ($_FILES["event_image"]["type"]=="image/jpeg") || ($_FILES["event_image"]["type"] == "image/jpg") && ($_FILES["event_image"] ["size"] < 52428800) && in_array($event_image_extension,  $allowedExts))
{
...
echo $sql="insert into tbl_event(event_name,event_from_date,event_to_date,event_from_time,event_to_time,event_location,lat,lng,city_name,place_id,map_url,formatted_address,event_image,event_price,event_no_of_ticket,event_email,event_description,created,status,couple_male_female_swingers,couple_female_female_swingers,couple_male_male_swingers,couple_male_swingers,couple_female_swingers,couple_transgender_swingers,event_type,additional_room_night_price,additional_room_night_fee,additional_room_night_days)values('$event_name','$event_from_date','$event_to_date','$event_from_time','$event_to_time','$event_location','$lat','$lng','$city_name','$place_id','$map_url','$formatted_address','$event_image','$event_price','$event_no_of_ticket','$event_email','$event_description','$current_date','$status','$couple_male_female_swingers','$couple_female_female_swingers','$couple_male_male_swingers','$couple_male_swingers','$couple_female_swingers','$couple_transgender_swingers','$event_type','$additional_room_night_price','$additional_room_night_fee','$additional_room_night_days')"; 
