...
echo $updt="update tbl_event set event_name='$event_name',event_from_date='$event_from_date',event_to_date='$event_to_date',event_from_time='$event_from_time',event_to_time='$event_to_time',lat='$lat',lng='$lng',city_name='$city_name',place_id='$place_id',map_url='$map_url',formatted_address='$formatted_address',event_image='$event_image',event_price='$event_price',event_no_of_ticket='$event_no_of_ticket',event_email='$event_email',event_description='$event_description',event_type='$event_type',couple_male_female_swingers='$couple_male_female_swingers',couple_female_female_swingers='$couple_female_female_swingers',couple_male_male_swingers='$couple_male_male_swingers',couple_male_swingers='$couple_male_swingers',couple_female_swingers='$couple_female_swingers',couple_transgender_swingers='$couple_transgender_swingers',additional_room_night_price='$additional_room_night_price' ,additional_room_night_fee='$additional_room_night_fee',additional_room_night_days='$additional_room_night_days' where id = $pid "; 
