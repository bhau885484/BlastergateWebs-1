                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                         <div class="form-group mb-3">
                            ...
                            <input type="time" class="form-control" placeholder="Enter event time"  aria-label="name" aria-describedby="basic-addon1" name="event_time" id="event_time">
                     ...
                     <div class="col-md-4">
                       <div class="form-group mb-3">
                          <label id="basic-addon1">Enter Price <span class="error_msg">*</span></label>
                     ...
                     <div class="col-md-4">
                       <div class="form-group mb-3">
                          <label id="basic-addon1">Enter Number Of Ticket <span class="error_msg">*</span></label>
