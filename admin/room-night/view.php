...
<div class="main-content side-content pt-0">
   <div class="container-fluid">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
         <div>
            <h2 class="main-content-title fs-24 mb-1">All Extra Room Night</h2>
            <ol class="breadcrumb mb-0">
               <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
               <li class="breadcrumb-item active" aria-current="page">All Extra Room Night</li>
            </ol>
         </div>
         <!--  <div class="d-flex">
         ...
         <div class="col-xl-12">
            <div class="card custom-card">
               <div class="card-header">
                  <div class="card-title"> Extra Room Night List </div>
               </div>
               <div class="card-body">
                  <div class="table-responsive">
                     <div id="datatable-basic_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                      ...
                      <?php 
                            ...
                            $sql = "select * from  tbl_extra_night_room  WHERE 1 = 1 {$whereSQL1} {$whereSQL2} order by created desc";
...
<!--                                         <td><?php if($user['room_type'] == 'single'){ ?>
                                      ...
                                      <td><?php echo $user['people_available']; ?></td>
