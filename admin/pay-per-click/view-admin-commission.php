...
<div class="main-content side-content pt-0">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h2 class="main-content-title fs-24 mb-1">Chocolate Factory Admin Commission</h2>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">Chocolate Factory Admin Commission </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable-basic_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                ...
                                <?php 
                                      ...
                                      $sql = "select * from  tbl_pay_per_click_admin_commission  order by id asc";
                                          ...
                                          <tbody>
                                            ...
                                            { ?>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $user['total_commission']; ?> %</td>
                                                  <td><?php echo $user['user_commission']; ?>%</td>
                                                  <td><?php echo $user['admin_commission']; ?>%</td>
                                                  
                                                  <td>
                                                    <a href="edit-admin-commission.php?pid=<?php print $user['id']?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;
