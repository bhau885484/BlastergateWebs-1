...
<div class="main-content side-content pt-0">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h2 class="main-content-title fs-24 mb-1">Chocolate Factory Image Price</h2>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Users</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Image Price</li>
                </ol>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">Chocolate Factory Image Price </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable-basic_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                ...
                                <?php 
                                      ...
                                      $sql = "select * from  tbl_pay_per_click_image_price  order by id asc";
                                          ...
                                          <tbody>
                                            ...
                                            { ?>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                    <a href="edit-photo-price.php?pid=<?php print $user['id']?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;
