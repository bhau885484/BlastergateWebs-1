...
<div class="main-content side-content pt-0 span-12" >
   <div class="main-container container-fluid">
      <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
         <div>
            <h2 class="main-content-title fs-24 mb-1">Plan Management</h2>
                  ...
                  <div class="card-body">
                     <form>
                        <div class="form-group mb-3">
                           <label id="">Plan Title</label>
                           <input type="text" class="form-control" placeholder="Enter Plan Title" name="title">
                        </div>
                        <div class="form-group mb-3">
                           <label id="">Plan Amount</label>
                           <input type="number" class="form-control" placeholder="Enter Plan Amount" name="title">
                        </div>
                        <div class="form-group mb-3">
                           <label id="">Day Limit</label>
                           <input type="name" class="form-control" placeholder="Day Limit" name="title">
                        </div>
                        <div class="form-group mb-3">
                           <label id="basic-addon1">Plan Description</label>
