                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <nav class="nav nav-pills flex-column flex-sm-row" role="tablist"> 
                          ...
                          ?>
                          <a class="flex-sm-fill text-sm-center nav-link <?php echo $profile_active ?>" data-bs-toggle="tab" role="tab" aria-current="page" href="#pill-flex-home" aria-selected="true">Personal Info</a>

                           <a class="flex-sm-fill text-sm-center nav-link <?php echo $image_active ?>" data-bs-toggle="tab"
                            role="tab" aria-current="page" href="#pill-flex-big" aria-selected="false" tabindex="-1">Photo</a>

                            <a class="flex-sm-fill text-sm-center nav-link <?php echo $video_active ?>" data-bs-toggle="tab" role="tab" aria-current="page" href="#pill-flex-about"
                            aria-selected="false" tabindex="-1">Video</a> 

                             <a class="flex-sm-fill text-sm-center nav-link <?php echo $album_active ?>" data-bs-toggle="tab" role="tab" aria-current="page" href="#pill-flex-album"
                            aria-selected="false" tabindex="-1">Album</a> 

                        </nav>
                        <div class="tab-content">
                          <div class="tab-pane <?php echo $profile_active ?> text-muted" id="pill-flex-home" role="tabpanel">
                                  ...
                                  <div class="col-md-12">
                                    <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_female_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?> ></p>

                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_female_female_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_male_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_female_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_transgender_swingers'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>

                                      </div>
                                      <div class="col-md-4">
                                        <div class="profile_interest">HOOKUP/MEETUP</div>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_female_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_female_female_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_male_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_male_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_female_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                        <p class="text-muted ms-0 mb-2"><input type="checkbox" class="accent-maroon" <?php if($rown_profile['couple_transgender_hookup_meetup'] == '1'){ echo "checked"; }else{ echo "disabled"; }?>></p>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <div class="tab-pane text-muted <?php echo $image_active ?>" id="pill-flex-big" role="tabpanel">
                            <div class="tab_content">
                              <div class="row">
                                ...
                                <?php 
                                 ...
                                 //echo "select * from tbl_profile_image where user_id=$user_id";
                                  ...
                                  $results_profile_image_no_rows = mysqli_num_rows($results_profile_image);
                                  if($results_profile_image_no_rows > 0){
                              ...
                              <?php } ?>
                               <?php } else{ ?>
                                <p style="text-align: center;color: #800020;font-size: 16px;padding-top: 20px;font-weight: bold;">No Image Available</p>
                               <?php }  ?>
                              </div>
                            </div>      
                          ...
                          <div class="tab-pane text-muted <?php echo $video_active ?>" id="pill-flex-about" role="tabpanel">
                            <div class="tab_content">
                              <div class="row">
                          ...
                          <div class="tab-pane text-muted <?php echo $album_active ?>" id="pill-flex-album" role="tabpanel">
                            <div class="tab_content">
                              <div class="row">
