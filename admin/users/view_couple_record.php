                          ...
                          <div class="tab-pane show active text-muted" id="pill-flex-home" role="tabpanel">
                              <div class="tab_content">
                                <div class="row">
                                 ...
                                 <?php if($rown['couple_profile_gender_from'] != '0') { ?>
                                   <div class="col-md-4">
                                    <?php if($rown['couple_profile_gender_from'] == '1') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 1 Gender:</b></span><span>Male</span> </p>
                                    <?php } ?>
                                    <?php if($rown['couple_profile_gender_from'] == '2') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 1 Gender:</b></span><span>Female</span> </p>
                                    <?php } ?>
                                    <?php if($rown['couple_profile_gender_from'] == '3') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 1 Gender:</b></span><span>Transgender</span> </p>
                                    <?php } ?>
                                    
                                    </div>
                                  <?php } ?>

                                  <?php if($rown['couple_profile_gender_to'] != '0') { ?>
                                   <div class="col-md-4">
                                    <?php if($rown['couple_profile_gender_to'] == '1') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 2 Gender:</b></span><span>Male</span> </p>
                                    <?php } ?>
                                    <?php if($rown['couple_profile_gender_to'] == '2') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 2 Gender:</b></span><span>Female</span> </p>
                                    <?php } ?>
                                    <?php if($rown['couple_profile_gender_to'] == '3') { ?>
                                      <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Person 2 Gender:</b></span><span>Transgender</span> </p>
                                    <?php } ?>
                                  ...
                                  <?php if($rown['couple_profile_gender_from'] == '3') { 
                                    $person1_gender = 'Transgender';
                                  } ?>
                                  <div class="profile_interest">Person 1 (<?php echo $person1_gender ?>)</div>
                                  <div class="col-md-4">
                                  ...
                                  <?php if($rown['couple_profile_gender_to'] == '3') { 
                                    $person2_gender = 'Transgender';
                                  } ?>
                                  <div class="profile_interest">Person 2 (<?php echo $person2_gender ?>)</div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>DOB:</b></span><span><?php echo $rown_profile['person2_dob']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Body Hair:</b></span><span><?php echo $rown_profile['person2_body_hair']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Height:</b></span><span><?php echo $rown_profile['person2_height']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Weight:</b></span><span><?php echo $rown_profile['person2_weight']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Body Type:</b></span><span><?php echo $rown_profile['person2_body_type']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Ethnic Background:</b></span><span><?php echo $rown_profile['person2_ethnic_background']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Smoking:</b></span><span><?php echo $rown_profile['person2_smoking']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Drinking:</b></span><span><?php echo $rown_profile['person2_drinking']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Piercings:</b></span><span><?php echo $rown_profile['person2_piercings']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Tattoos:</b></span><span><?php echo $rown_profile['person2_tattoos']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Language Spoken:</b></span><span><?php echo $rown_profile['person2_language_spoken']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Circumcised:</b></span><span><?php echo $rown_profile['person2_circumcised']?></span> </p>
                                  </div>

                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Intelligence as importance?:</b></span><span><?php echo $rown_profile['person2_intelligence_importance']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Sexuality:</b></span><span><?php echo $rown_profile['person2_sexuality']?></span> </p>
                                  </div>
                                  <div class="col-md-4">
                                    <p class="text-muted ms-0 mb-2"><span class="font-weight-semibold me-2"><b>Relationship Orientation:</b></span><span><?php echo $rown_profile['person2_relationship_orientation']?></span> </p>
                                  </div>
