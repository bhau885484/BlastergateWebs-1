...
echo $sql="insert into tbl_event(event_name,event_from_date,event_to_date,event_from_time,event_to_time,event_location,lat,lng,city_name,place_id,map_url,formatted_address,event_image,event_price,event_no_of_ticket,event_email,event_description,created,status,couple_male_female_swingers,couple_female_female_swingers,couple_male_male_swingers,couple_male_swingers,couple_female_swingers,couple_transgender_swingers,event_type,additional_room_night_price,additional_room_night_fee)values('$event_name','$event_from_date','$event_to_date','$event_from_time,'$event_to_time','$event_location','$lat','$lng','$city_name','$place_id','$map_url','$formatted_address','$event_image','0','$event_no_of_ticket','$event_email','$event_description','$current_date','$status','$couple_male_female_swingers','$couple_female_female_swingers','$couple_male_male_swingers','$couple_male_swingers','$couple_female_swingers','$couple_transgender_swingers','$event_type','$additional_room_night_price','$additional_room_night_fee')"; 
