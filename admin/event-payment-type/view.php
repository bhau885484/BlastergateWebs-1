...
<div class="main-content side-content pt-0">
   <div class="container-fluid">
      ...
      <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
         <div>
            <h2 class="main-content-title fs-24 mb-1">All Event Payment Type</h2>
            <ol class="breadcrumb mb-0">
               <li class="breadcrumb-item"><a href="javascript:void(0)">home</a></li>
               <li class="breadcrumb-item active" aria-current="page">All Event Payment Type</li>
            </ol>
         </div>
         <!--  <div class="d-flex">
         ...
         <div class="col-xl-12">
            <div class="card custom-card">
               <div class="card-header">
                  <div class="card-title"> Event Payment Type List </div>
               </div>
               <div class="card-body">
                  <div class="table-responsive">
                     <div id="datatable-basic_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                      ...
                      <?php 
                            ...
                            $sql = "select * from  tbl_event_payment_type";
                                 ...
                                 <tbody>
                                  ...
                                  { ?>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $user['payment_name'] ?></td>
                                       <td><?php echo $user['payment_type']; ?>% Of Total Amount</td>
                                       <td>$<?php echo $user['payment_fee']; ?></td>
