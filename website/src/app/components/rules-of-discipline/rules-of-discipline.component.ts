...
@Component({
  selector: 'app-rules-of-discipline',
  templateUrl: './rules-of-discipline.component.html',
  styleUrls: ['./rules-of-discipline.component.css']
})
export class RulesOfDisciplineComponent implements OnInit {
