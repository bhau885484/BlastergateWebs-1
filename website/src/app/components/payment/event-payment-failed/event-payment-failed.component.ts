...
@Component({ 
  selector: 'app-event-payment-failed',
  templateUrl: './event-payment-failed.component.html',
  styleUrls: ['./event-payment-failed.component.css']
})
export class EventPaymentFailedComponent implements OnInit {
