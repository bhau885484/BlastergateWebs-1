...
export class NotesComponent implements OnInit {
  ...
  public getallFriendRequest(bodydata){
    ...
    this.callapi.post('/feed/get_all_notes_request',bodydata).subscribe(data => {
      $('#preloader').hide();
       this.title_heading = 'Whom I Notes';
  ...
  //   this.callapi.get('/feed/get_all_send_notes_request').subscribe(data => {
  //       this.title_heading = 'Who Notes Me';
  //        this.pending_data=false;
  //       if(data.status == 200){
  //         this.allFriendRequestData = data.data;
  //       }else{
