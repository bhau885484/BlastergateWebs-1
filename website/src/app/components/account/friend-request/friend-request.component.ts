...
export class FriendRequestComponent implements OnInit {
  ...
  public getallFriendRequest(bodydata){
    // $('#preloader').show();
     this.callapi.post('/feed/get_all_friend_request',bodydata).subscribe(data => {
       $('#preloader').hide();
        // this.pending_data=false;
        if(data.status == 200){

          if(this.bodydata['type']=='pending'){
  ...
  //   $('#preloader').show();
  //   this.callapi.get('/feed/get_all_send_friend_request').subscribe(data => {
  //     $('#preloader').hide();
  //       this.allFriendRequestData ='';
  //       this.title_heading = 'Send Friends Request';
  //        this.pending_data=false;
  //       if(data.status == 200){
  //         this.allFriendRequestData = data.data;
  //          this.loaderFlag = true;

  //         console.log('this.allFriendRequestDataSend',this.allFriendRequestData);
  //       }else{
  //         this.allFriendRequestData = '';
  //          this.loaderFlag = true;
  //       }
  ...
  //       this.title_heading = 'Pending Friends Request';
  //        this.pending_data=true;
  //       if(data.status == 200){
  //          this.loaderFlag = true;
  //         this.allFriendRequestData = data.data;
  ...
  // public deniedFriendRequest(){
  //   $('#preloader').show();
  //   this.callapi.get('/feed/get_all_denied_friend_request').subscribe(data => {
  //     $('#preloader').hide();
  //       this.allFriendRequestData ='';
  //       this.title_heading = 'Denied Friends Request';
  //        this.pending_data=false;
  //       if(data.status == 200){
  //          this.loaderFlag = true;
  //         this.allFriendRequestData = data.data;
  ...
  // public getlatestFriendRequest(){
  //   $('#preloader').show();
  //   this.callapi.get('/feed/get_all_latest_friend_request').subscribe(data => {
  //     $('#preloader').hide();
  //       this.allFriendRequestData ='';
  //       this.title_heading = 'Latest Friends Request';
  //        this.pending_data=false;
  //       if(data.status == 200){
  //          this.loaderFlag = true;
  //         this.allFriendRequestData = data.data;
  ...
  // public profileFriendRequest(types){
  //   $('#preloader').show();

  //   var obj={
  //     "types": types
  //   }
  //   this.callapi.post('/feed/get_profile_type_friend_request',obj).subscribe(data => {
  //     $('#preloader').hide();
  //       this.allFriendRequestData ='';
  //       this.title_heading = 'Latest Friends Request';
  //        this.pending_data=false;
