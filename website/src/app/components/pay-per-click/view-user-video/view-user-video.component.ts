...
@Component({
  selector: 'app-view-user-video',
  templateUrl: './view-user-video.component.html',
  styleUrls: ['./view-user-video.component.css']
})
export class ViewUserVideoComponent implements OnInit {
  ...
  public savePayment() {
        ...
        if (this.paymentgetwayForm.valid) {
          ...
          var newobj={
              ...
              'video_id': this.select_image_id,
              'video_title':this.single_image_price.title,
              "video_price":this.single_image_price.price,
              "video_day":this.single_image_price.day,
